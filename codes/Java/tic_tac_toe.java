...
public class tic_tac_toe {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i <= 9; i++) {
      ...
      if (input <= 9 && input >= 1) {
        ...
        if (filled) {
          ...
          if (userWon > 0) {
            System.out.println(
              "Congrats " +
              thisClass.getPlayerChar(userWon) +
      ...
      System.out.println(
        "You have entered a number out of range please enter a number from 1 to 9"
      );
  ...
  private void PrintCurrentState() {
    System.out.println(
      "| " +
      (hole1 > 0 ? this.getPlayerChar(hole1) : "hole1") +
      " | " +
    ...
    System.out.println(
      "| " +
      (hole4 > 0 ? this.getPlayerChar(hole4) : "hole4") +
      " | " +
    ...
    System.out.println(
      "| " +
      (hole7 > 0 ? this.getPlayerChar(hole7) : "hole7") +
      " | " +
